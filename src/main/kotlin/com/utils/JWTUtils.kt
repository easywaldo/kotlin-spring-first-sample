...
object JWTUtils {
    fun createToken(claim: JWTClaim, properties: JWTProperties) = JWT.create()
...
data class JWTClaim(val userId: Long, val email: String, val profileUrl: String, val userName: String)
